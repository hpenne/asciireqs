...
* link_error: This takes the requirement object as a parameter and returns true if the requirement has a link to one or more parents, where the parent has no link back to the requirement.
